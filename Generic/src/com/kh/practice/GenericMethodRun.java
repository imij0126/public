...
class DataClass02_1<T>{
    public <K> void test(T data, K data2){//클래스에 T ,접근제한자에서 K선언
...
public class GenericMethodRun {
    public static void main(String[] args) {
        ...
        d1.test(123456);        // 타입을 지정하지 안흥면,T -->Object로 변환
        d1.<Double>test(777);   // T --> Double

        d1.test2("Microsoft,Tesla");    // 제네릭타입 자동으로 결정 T --> String
        ...
        d2.<String>test("Test3","zzz");//세번째 매개변수
    }
}
