...
public class GenericRun {
    /*
        ...
        - 제네릭 틀래스
            [접근제한지] [예약어] class 클래스명 <T> {      // T : 타입 매개변수
                // [1] 필드의 데이터 타입
                T value;
                // [2] 메소드의 매개변수 타입
            ...
            => 제네릭 클래스 객체 생성 시 데이터 타입을 결정 -> 명시하지 않으면 Object으로 처리 됨
               데이터 타입으로 기본 자료형은 사용할 수 없음 => Wrapper 클래스를 사용해야 함
           - 제네릭 메소드

                   [접근제한자] [예약어] <T> 반환타입 메소드명 ([매개변수]) {}
                   // 타입 매개변수 적용 범위 : 매개변수 타입 / 반환타입 / 메소드 내 지역변수 타입으로 사용 가능
           - 제네릭 타입 제한
                * <T> : 제한없이 어떤 타입이든 허용
                * <T extends 클래스 A> : 클래스A 또는 클래스A 를 상속받은 클래스만 허용
                * <T implements 인터페이스 A> : 인터페이스A를 구현한 클래스만 허용
