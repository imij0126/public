...
public class OperatorRun {
    public static void main(String[] args) {
        ...
        boolean b2 = !b1; // b2 => false 변수의 값을 부정해 대입
        boolean b3 = !(10 % 2 == 0); // b3 => false 연산 결과의 값을 부정해 대입
        //----------------------------
        /*
            증감 연산자 (단항연산자)
            - 연산자
        ...
        System.out.println("n1 - n2 = " + (n1 - n2));
        System.out.println("n1 * n2 = " + n1 * n2); // 우선순위가 *라서 상관 x
        System.out.println("n1 / n2 = " + (n1 / n2));
        System.out.println("n1 % n2 = " + (n1 % n2));
        if (n1 % 2 ==0){System.out.println("짝수입니다.");
        }else {System.out.println("홀수입니다.");}
        if (n2 % 3 ==0){System.out.println("짝수입니다.");}else {System.out.println("홀수입니다.");}
        /*
            * 비교연산자/관계연산자 (이항연산자)
            *   - 두 값을 비교하는 연산자
        ...
        System.out.println( (A * 2) > (B / 3)); // 산술 연산이 비교 연산보다 먼저 수행
        ...
        /*
            ...
            : 두 개의 논리값을 연산해주는 연산자
             ...
             - 연산자
                * 논리값 && 논리값 : 왼쪽, 오른쪽 값이 모두 true 일때 결과가 true
                * 논리값 || 논리값 : 왼쪽, 오른쪽 둘 중 하나라도 true 일 때 결과가 true
         */
        int num = 55;
        // num 변수에 저장된 값이 1 이상이고, 100 이하인경우 1<= num <= 100
        boolean r2 = (num >= 1) && (num <= 100);
        System.out.println("num의 값은 1이상 100 이하의 수인가?" + r2);
        // && : ~이고, 그리고, ~하면서
        ...
        // && 연산의 경우 왼쪽 결과가 false 인 경우 오른쪽의 연산이 수행되지 않는다.

        boolean r5 = (num > 0) || (num++ > 1);
        System.out.println("r5 : " + r5 + ", num : " +num);     //r5 : true, num
