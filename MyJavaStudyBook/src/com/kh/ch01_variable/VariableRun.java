...
public class VariableRun {
    ...
    public static void main(String[] args) {
        /*
            * 변수를 사용하는 이유
            * 1) 값에 의미를 부여하기 위해 사용(가독성이 높아진다)
            * 2) 한번 값을 기록하고 필요할 때마다 사용(재사용성 높아짐)
            * 3) 유지보수를 보다 쉽게할 수 있음
            ----------------------------------
            ...
            * [표현법]
            *       자료형 변수이름;
            *       * 자료형 : 변수의 크기 모양을 지정하는 부분
            *       * 변수이름 : 변수의 이름을 붙여주는 부분
            *   - 변수 선언 시 주의할 점
            *     1) 변수의 이름은 소문자로 시작(낙타표기법(카멜케이스)를 지켜야 함. 예악어 사용 x)
        ...
        MAX_SIZE = 1024;
        //MAX_SIZE = 1024*10  오류 한번 저장을 하면 변경 불가!
        /*
            * 형변환 : 값의 자료형을 바꾸는 것
        ...
        int i2 = 10;
        double d2 = 5.5;
        double r1 = /*(double)*/i2+ d2; // 10 + 5.5 => 10.0
        ...
        //      실수형인 float 자료형에 담을수 있는 값의 범위가 더 크기 때문에 자동 형변환이 진행
        ...
        // char 의 경우 음수값 저장 가능? 가지고 있는 수의 범위가 0~65535
        // char c2 = -10;
        char c2 = 22222;
        System.out.println("c2 : " +c2);
        System.out.println((int) '김' + " " + (int)'인' + " " + (int) '창');
    }
}
