...
public class ObjectRun {
    public static void main(String[] args) {
        /*
            ...
            *                               가상세계로 구현하는 과정
            *  => 프로그램 상에 필요한 객체들을 만들기 위해 "class" 라는 틀을 먼저 만들어야함 !
            *       * 클래스 : 객체들의 속성(정보)들을 담고 있는 틀
            *
            * -> 추상화 과정 : 대상 객체에 대하여 정리하는 작업
            *    [1] 프로그램에서 필요한 대상 객체 선정
            *    [2] 객체들이 가지고 있는 공톡적인 속성, 기능들을 모두 추출
        ...
        /*
            ...
            * 캡슐화 : 외부로부터 "데이터의 직접 접근"을 막고,
             ...
             [2] getter/setter 메소드 : private 으로 제한된 필드 간접적으로 접근할 수 있도록 기능을 제공하는 메소드
        ...
        animal.setType("고슴도치");
        animal.setGender('M');
        animal.setMasterName("이주원");
        animal.setAge(2);
        System.out.println(animal);
        Animal animal2 = new Animal("초롱이",5,'M',"민욱님","고양이");
        System.out.println(animal2);
        Student stu1 = new Student("김인창",30,167.5,"010-7197-3770","서울시 동작구");
