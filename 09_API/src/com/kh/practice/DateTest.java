...
public class DateTest {
    public static void main(String[] args) {
        ...
        System.out.println(date2.getMonthValue()+"/"+date.getDay());

        // 생일 출력
        LocalDateTime birth = LocalDateTime.of(LocalDate.of(1995,1,26),
                LocalTime.of(16,0));
        ...
        // 올해 며칠 남았는지?              getDayOfYear()
        // 오늘 퇴근까지 몇 시간 남았는지?    getHour()
        LocalDateTime today = LocalDateTime.now();
        System.out.println("올해는 " + (366-today.getDayOfYear()) +"일 남았다");
