...
public class SetPractice {
    public static void main(String[] args) {
        /*
            * Object
            *       - equals()  : 두 객체의 "주소값"을 비교하여 일치하면 true. 일치하지 않으면 false 반환
        ...
        /*
            String
                 - equals() : 재정의됨. "실제 담긴 문자열" 을 가지고 동등비교하여 일치하면 true,아니면 false
        ...
        /*
            Set 특징
             ...
             해쉬 (hash) 알고리즘 : 특정 기준에 따라 데이터를 분류하는 방식 (알고리즘)
             - HashSet
        ...
        hSet2.add(new Person("김인창", 34, 165));
        ...
        /*  Person
                - equals() : 실제 각 필드에 담긴 데이터들이 모두 일치하면 true, 아니면 false
                - hashCode() : 재정의. 실제 각 필드에 담긴 데이터들을 합해서 10진수 반환
         */
        // ---------------------------------
        //  HashSet 공간에 객체가 추가될때마다 동일객체인지 비교하여 추가함!
        //  => 동일 객체 판단 기준 : hashCode 결과가 일치하고. equals 메소드 비교 시 true 일때
        //----------------------------------
        // *** 데이버 조회하기 ***
